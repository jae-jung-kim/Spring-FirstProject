...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3: 9번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = List.of();
            // 4. 비교 및 검증
            assertEquals(comments.toString(), expected.toString(), "9번 글 자체가 없으므로 댓글 비어있어야함");
        }
        ...
        /* Case 4: 999번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = List.of();
            // 4. 비교 및 검증
            assertEquals(comments.toString(), expected.toString(), "999번 글 자체가 없으므로 댓글 비어있어야함");
        }
        ...
        /* Case 5: -1번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = List.of();
            // 4. 비교 및 검증
            assertEquals(comments.toString(), expected.toString(), "-1번 글 자체가 없으므로 댓글 비어있어야함");
        }
    }
